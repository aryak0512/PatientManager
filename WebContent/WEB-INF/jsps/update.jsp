...
<%@page import="com.demo.model.Patient" %>
<!DOCTYPE html>
<html>
<head>
...
<div class="topnav"> 
  ...
  <a id="active-link"   href="update-page">Update Patient</a>
...
<p align="center" style="font-size: 35px; font-weight: bold;">UPDATE PATIENT</p>
...
<div class="contain">
	    ...
	    <div class="col-lg-6" align="center" id="maindiv">
				<form method="post" action="${pageContext.request.contextPath}/process-update-search">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a id="selectbutton" href="${pageContext.request.contextPath}/updatePatient?id=${p.getId()}">UPDATE INFO</a>
				</p>
				<hr>
				</c:forEach>
